...
; that it takes as its third argument a sequence of
; sequences, which are all assumed to have the same number
; of elements. It applies the designated accumulation
; procedure to combine all the first elements of the
; sequences, all the second elements of the sequences, and;
; so on, and returns a sequence of the results. For
